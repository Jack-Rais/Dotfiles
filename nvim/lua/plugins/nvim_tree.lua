...
require("nvim-tree").setup({
    ...
    on_attach = function(bufnr)
        ...
        vim.keymap.set("n", "<leader>o", function() api.node.open.edit() api.tree.close() end)
        vim.keymap.set("n", "<leader>q", function() vim.api.nvim_win_close(vim.api.nvim_get_current_win(), false) end)

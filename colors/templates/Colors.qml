...
QtObject {
    ...
    // Primary
    property color primary: "{{ colors.primary.light.hex }}"
    property color on_primary: "{{ colors.on_primary.light.hex }}"
    property color primary_container: "{{ colors.primary_container.light.hex }}"
    property color on_primary_container: "{{ colors.on_primary_container.light.hex }}"
    property color inverse_primary: "{{ colors.inverse_primary.light.hex }}"
    ...
    // Secondary
    property color secondary: "{{ colors.secondary.light.hex }}"
    property color on_secondary: "{{ colors.on_secondary.light.hex }}"
    property color secondary_container: "{{ colors.secondary_container.light.hex }}"
    property color on_secondary_container: "{{ colors.on_secondary_container.light.hex }}"
    ...
    // Tertiary
    property color tertiary: "{{ colors.tertiary.light.hex }}"
    property color on_tertiary: "{{ colors.on_tertiary.light.hex }}"
    property color tertiary_container: "{{ colors.tertiary_container.light.hex }}"
    property color on_tertiary_container: "{{ colors.on_tertiary_container.light.hex }}"
    ...
    // Error
    property color error: "{{ colors.error.light.hex }}"
    property color on_error: "{{ colors.on_error.light.hex }}"
    property color error_container: "{{ colors.error_container.light.hex }}"
    property color on_error_container: "{{ colors.on_error_container.light.hex }}"

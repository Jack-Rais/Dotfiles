return {
    ...
    config = function()
        ...
        local icons_pack = require("utils.icons")
        ...
        table.insert(gls.left, {
            DiagnosticError = {
                ...
                icon = icons_pack.get("diagnostics", false).Error_alt,
                separator_highlight = { colors.gitbg, colors.bg },
        ...
        table.insert(gls.left, {
            DiagnosticHint = {
                ...
                icon = icons_pack.get("diagnostics", false).Hint,
        ...
        table.insert(gls.left, {
            DiagnosticInfo = {
                ...
                icon = icons_pack.get("diagnostics", false).Information_alt,
